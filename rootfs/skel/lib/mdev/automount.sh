...
# Maybe we should save Part2 (max addr)
# dd if=/dev/mmcblk0p2 /tmp/mmcblk0p2.bin	# read
# dd if=/tmp/mmcblk0p2.bin /dev/mmcblk0p2	# write

# Also bp3.bin of Part 4/5 maybe/should be saved.

destdir=/mnt/usb

bp30dev=/dev/mmcblk0p4
bp31dev=/dev/mmcblk0p5
splashdev=/dev/mmcblk0p8

kerneldev=/dev/mmcblk0p6
rootfsdev=/dev/mmcblk0p9
rootfsdevSize=`cat /proc/partitions | grep mmcblk0p9 | awk '{print $3}'`

startup=/dev/mmcblk0p6

kerneldev_1=/dev/mmcblk0p9
rootfsdev_1=/dev/mmcblk0p10
rootfsdevSize_1=`cat /proc/partitions | grep mmcblk0p10 | awk '{print $3}'`

kerneldev_2=/dev/mmcblk0p11
rootfsdev_2=/dev/mmcblk0p12
rootfsdevSize_2=`cat /proc/partitions | grep mmcblk0p12 | awk '{print $3}'`

kerneldev_3=/dev/mmcblk0p13
rootfsdev_3=/dev/mmcblk0p14
rootfsdevSize_3=`cat /proc/partitions | grep mmcblk0p14 | awk '{print $3}'`

kerneldev_4=/dev/mmcblk0p15
rootfsdev_4=/dev/mmcblk0p16
rootfsdevSize_4=`cat /proc/partitions | grep mmcblk0p16 | awk '{print $3}'`
...
mk_partition () {
	...
	mk_standard_part () {
		sgdisk -a 1 -n 1:1408:1535 -c 1:"nvram" /dev/mmcblk0
		sgdisk -a 1 -n 2:1536:1663 -c 2:"macadr" /dev/mmcblk0
		sgdisk -a 1 -n 3:1664:1791 -c 3:"devtree" /dev/mmcblk0
		sgdisk -a 1 -n 4:1792:1919 -c 4:"bp30" /dev/mmcblk0
		sgdisk -a 1 -n 5:1920:2047 -c 5:"bp31" /dev/mmcblk0
		sgdisk -a 1 -n 6:2048:34815 -c 6:"kernel" /dev/mmcblk0
		sgdisk -a 1 -n 7:34816:67583 -c 7:"initrd" /dev/mmcblk0
		sgdisk -a 1 -n 8:67584:71679 -c 8:"splash" /dev/mmcblk0
		sgdisk -a 1 -n 9:71680:${ENDSECTOR} -c 9:"rootfs" /dev/mmcblk0
		mkfs.ext4 $1
	}
	mk_multiboot_simple_part () {
		...
		sgdisk -a 1 -n 4:1792:1919 -c 4:"bp30" /dev/mmcblk0
		sgdisk -a 1 -n 5:1920:2047 -c 5:"bp31" /dev/mmcblk0
		sgdisk -a 1 -n 6:2048:2175 -c 6:"startup" /dev/mmcblk0
		sgdisk -a 1 -n 7:2176:34943 -c 7:"initrd" /dev/mmcblk0
#		sgdisk -a 1 -n 8:34944:39039 -c 8:"splash" /dev/mmcblk0
		sgdisk -a 1 -n 8:34944:38911 -c 8:"splash" /dev/mmcblk0
		mkfs.vfat $1
	}
	mk_multiboot_part_1 () {
		sgdisk -a 1 -n 9:38912:51199 -c 9:"kernel_1" /dev/mmcblk0
		sgdisk -a 1 -n 10:51200:1937407 -c 10:"rootfs_1" /dev/mmcblk0
		mkfs.ext4 $1
	}
	mk_multiboot_part_2 () {
		sgdisk -a 1 -n 11:1937408:1949695 -c 11:"kernel_2" /dev/mmcblk0
		sgdisk -a 1 -n 12:1949696:3835903 -c 12:"rootfs_2" /dev/mmcblk0
		mkfs.ext4 $1
	}
	mk_multiboot_part_3 () {
		sgdisk -a 1 -n 13:3835904:3848191 -c 13:"kernel_3" /dev/mmcblk0
		sgdisk -a 1 -n 14:3848192:5734399 -c 14:"rootfs_3" /dev/mmcblk0
		mkfs.ext4 $1
	}
	mk_multiboot_part_4 () {
		sgdisk -a 1 -n 15:5734400:5746687 -c 15:"kernel_4" /dev/mmcblk0
		sgdisk -a 1 -n 16:5746688:${ENDSECTOR} -c 16:"rootfs_4" /dev/mmcblk0
		mkfs.ext4 $1
	}
...
update_rootfs () {
	...
	|| [ -e ${destdir}/$1/$V_ROOTFS_4_FILENAME_GZ ]; then
		do_first_part () {
			...
			if [ $1 == 0 ]; then
				echo "boot flash0.kernel_1 'root=/dev/mmcblk0p10 rootfstype=ext4 rootflags=data=journal rootwait rw coherent_pool=2M vmalloc=500m bmem=891m@1156m bmem=575m@3520m'" >> /mnt/startup/STARTUP # boot from first partition default
				echo "boot flash0.kernel_1 'root=/dev/mmcblk0p10 rootfstype=ext4 rootflags=data=journal rootwait rw coherent_pool=2M vmalloc=500m bmem=891m@1156m bmem=575m@3520m'" >> /mnt/startup/STARTUP_1
				echo "boot flash0.kernel_2 'root=/dev/mmcblk0p12 rootfstype=ext4 rootflags=data=journal rootwait rw coherent_pool=2M vmalloc=500m bmem=891m@1156m bmem=575m@3520m'" >> /mnt/startup/STARTUP_2
				echo "boot flash0.kernel_3 'root=/dev/mmcblk0p14 rootfstype=ext4 rootflags=data=journal rootwait rw coherent_pool=2M vmalloc=500m bmem=891m@1156m bmem=575m@3520m'" >> /mnt/startup/STARTUP_3
				echo "boot flash0.kernel_4 'root=/dev/mmcblk0p16 rootfstype=ext4 rootflags=data=journal rootwait rw coherent_pool=2M vmalloc=500m bmem=891m@1156m bmem=575m@3520m'" >> /mnt/startup/STARTUP_4
				echo "boot -fatfs usbdisk0:zImage 'root=/dev/sdb2 rw rootwait rootflags=data=journal rootfstype=ext4 systemd.gpt_auto=0 consoleblank=0 vt.global_cursor_default=0 loglevel=7 coherent_pool=2M vmalloc=500m bmem=891m@1156m bmem=575m@3520m'" >> /mnt/startup/STARTUP_USB_HDD
				echo "boot -fatfs usbdisk0:zImage 'root=/dev/sda2 rw rootwait rootflags=data=journal rootfstype=ext4 systemd.gpt_auto=0 consoleblank=0 vt.global_cursor_default=0 loglevel=7 coherent_pool=2M vmalloc=500m bmem=891m@1156m bmem=575m@3520m'" >> /mnt/startup/STARTUP_USB_NOHDD
			elif [ $1 == 1 ]; then
